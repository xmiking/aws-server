...
 		};
	...
	*/
	...
	function GetImage()
	{
		document.getElementById('ImageInput').src = "pic/trans_image.jpeg";
		var ImageInput = document.getElementById('ImageInput');
		if (typeof ImageInput.naturalWidth == "undefined") 
		{  
			// IE 6/7/8
			var img = new Image();
		...
		{
			// HTML5 browser
			var rw = ImageInput.naturalWidth;
			var rh = ImageInput.naturalHeight;
		}
		
		var p = Math.min(330/rw,250/rh);
		document.getElementById('ImageInput').width = rw*p;
		document.getElementById('ImageInput').height = rh*p;
	}
	/*	
		send command to ros
